...
function SignUpPage() {
  ...
  return (
    <div className={`bg-[#f8f9fc] ${isTab ? 'flex flex-col items-center justify-center' : 'flex justify-between h-[728px]'}`}>
      ...
      <div 
      className='bg-[#f6edff] rounded-2xl md:h-[660px] sm:h-[650px] xs:h-[620px] lg:w-[35%] md:w-[38%] sm:w-[85%] xs:w-[90%] lg:my-[2%] 
                  md:my-[4%] sm:my-[2%] xs:my-[5%] lg:mr-[5%] md:mr-[3.5%] flex flex-col items-center shadow-lg'>
        {showTutorSignUp ? (<TutorSignUpPage />) : showStudentSignUp ? (<StudentSignUpPage />) : (
          <div className='flex flex-col items-center'>
            <h1 className='lg:text-[30px] md:text-text1 sm:text-[30px] xs:text-text2 text-[#2e294e] font-semibold md:mt-[38%] sm:mt-[20%] xs:mt-[12%] mb-[1%]'>
            ...
            <button 
              ...
              className='bg-[#2e294e] md:w-[22vw] sm:w-[50vw] xs:w-[70vw] py-[5%] mb-[10%] font-semibold text-white rounded-full shadow-md 
                          hover:shadow-lg hover:bg-[#5e578a] transition-all duration-300'>
              Sign Up as Tutor
            </button>
            <button 
              onClick={handleStudentClick} 
              className='bg-[#2e294e] md:w-[22vw] sm:w-[50vw] xs:w-[70vw] py-[5%] mb-[5%] font-semibold text-white rounded-full shadow-md 
                          hover:shadow-lg hover:bg-[#5e578a] transition-all duration-300'>
              Sign Up as Student
            </button>
            <NavLink to={'/login'}>
