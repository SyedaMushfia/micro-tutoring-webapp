            ...
            <div>
                <div className=' flex flex-col justify-center shadow-lg w-full h-[200px] sm:px-[8%] xs:px-[10%] py-8 mt-4 rounded-2xl bg-[#f2f4fc]'>
                  <div className=' flex items-start justify-between'>
                    <div>
                        <h1 className='text-text4 tracking-wide text-[#555]'>Total Earnings</h1>
                        <h2 className='lg:text-[70px] md:text-[45px] sm:text-[50px] xs:text-[40px] font-semibold tracking-wide text-[#2e294e]'><span className="align-super text-2xl">Rs.</span>{userData?.tutor?.earnings}</h2>
                    </div>
