      ...
      <Table aria-label="simple table" className='mt-4 !md:w-[39.25vw]'>
        <TableHead>
          <TableRow>
            ...
            <TableCell align="right" className='bg-[#2e294e] !text-white font-semibold'>Tutor</TableCell>
            <TableCell align="right" className='bg-[#2e294e] !text-white font-semibold'>Date</TableCell>
            <TableCell align="right" className='bg-[#2e294e] !text-white font-semibold'>Amount Paid</TableCell>
        ...
        <TableBody>
            ...
            history.map((row, index) => (
              <TableRow key={index}>
                ...
                <TableCell align="right">Rs.{row.amountPaid}</TableCell>
                <TableCell
                  align="right"
